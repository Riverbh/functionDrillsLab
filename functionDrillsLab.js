...
console.log(`The biggest num: ${compareNums(2, 5)}`)
...
function add(param1, param2){
  return total = parseInt(param1) + parseInt(param2)
}

console.log(add('23a', '42berry'))
////////////////// PROBLEM 7 ////////////////////
...
console.log(exclaimThree("River is freakin' awesome!!!"))
...
function nameCheck(personName){
  if(personName === 'Steven'){
    return nameGreeting + 'What is up Steven?'
  }else if(personName === 'Bryan'){
    return nameGreeting + 'Hey Bryan!'
  }else{
    return nameGreeting + 'Cool name ' + personName
  }
}
